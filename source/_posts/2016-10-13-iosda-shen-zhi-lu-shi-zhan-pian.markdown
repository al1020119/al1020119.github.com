...
* [仿iOS猎豹垃圾清理(实现原理+源码)](http://www.devtf.cn/?p=562) -  仿iOS猎豹垃圾清理(实现原理+源码),用到私有API。1
...
* [iOS Material Design库](http://code.cocoachina.com/view/126073) - 该项目借鉴于谷歌的Material Design guideline，用户可自定义背景色。
